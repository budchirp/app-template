...
import me.budchirp.app.android.ui.motion.MotionConstants
...
fun DrawerContent(
    ...
    Column(
        ...
        val currentDestination = navBackStackEntry?.destination?.route ?: Route.Home.destination
...
fun Drawer(
    ...
    when (windowSizeClass.windowWidthSizeClass) {
        WindowWidthSizeClass.COMPACT, WindowWidthSizeClass.MEDIUM -> ModalNavigationDrawer(
            drawerContent = {
        ...
        WindowWidthSizeClass.EXPANDED -> PermanentNavigationDrawer(drawerContent = {
