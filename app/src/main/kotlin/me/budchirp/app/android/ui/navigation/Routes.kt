...
val settingRoutes = listOf(Route.GeneralSettings, Route.Appearance, Route.Languages, Route.About)
val appearanceRoutes = listOf(Route.Theme, Route.MaterialYou)
val aboutRoutes = listOf(Route.Licenses)
val allRoutes = mainRoutes + settingRoutes + appearanceRoutes + aboutRoutes

fun List<Route>.findByDestination(destination: String): Route {
    return allRoutes.find { route -> route.destination == destination } ?: Route.Home
}